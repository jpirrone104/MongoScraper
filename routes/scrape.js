    ...
    .then((savedArticles) => {
      ...
      savedArticles.map(article => article.headline);
        ...
        .then(function ($) {
          ...
          $('a.story-card').each((i, element) => {
            let newArticle = new db.Article({
              storyUrl: "https://vegnews.com" + $(element).attr('href'),
          ...
          db.Article
            ...
            .then(results => res.json({count: newArticleArr.length}))//returning count of new articles to front end
